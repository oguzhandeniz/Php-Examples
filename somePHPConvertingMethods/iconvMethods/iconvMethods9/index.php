...
<body>
    <?php
        ...
        */
        ...
        $value1		=	iconv_get_encoding("input_encoding");
        $value2		=	iconv_get_encoding("output_encoding");
        $value3		=	iconv_get_encoding("internal_encoding");
        
        echo "Girdi Karakter Seti Kodlaması : " . $value1 . "<br />";
        echo "Çıktı Karakter Seti Kodlaması : " . $value2 . "<br />";
        echo "Dahili Karakter Seti Kodlaması : " . $value3;
