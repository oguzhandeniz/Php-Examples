...
<body>
    <?php
        ...
        */
        ...
        echo "<pre>";
        echo "Girdi Karakter Seti Kodlaması : " . $value["input_encoding"] . "<br />";
        echo "Çıktı Karakter Seti Kodlaması : " . $value["output_encoding"] . "<br />";
        echo "Dahili Karakter Seti Kodlaması : " . $value["internal_encoding"] . "<br />";
        echo "</pre>";
