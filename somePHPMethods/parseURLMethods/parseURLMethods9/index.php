...
<body>
    <?php
        ...
        */
        ...
        parse_str($ozelSonuc);
        /*
            parse_str otomatik olarak bu işlemleri gerçekleştirdi.
            $EgitimTuru = "Yazilim";
            $Ozellikler = array("ScriptDili", "OrtaSeviye")
            $EgitimAlani= "Web";
        */
        
        echo "Query'nin EgitimTuru Değeri : " . $egitimTuru . "<br />";
        echo "Query'nin Ozellikler 0. Eleman Değeri : " . $ozellikler[0] . "<br />";
        echo "Query'nin Ozellikler 1. Eleman Değeri : " . $ozellikler[1] . "<br />";
        echo "Query'nin EgitimAlani Değeri : " . $egitimAlani;
