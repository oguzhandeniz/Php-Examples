...
<body>
    <?php
        ...
        */
        ...
        $result			=	str_word_count($value, 0, "ğĞüÜşŞıİöÖçÇ");
        
        echo $result . "<br /><br />";
        
        $processOne		=	str_word_count("Karabük Üniversitesi - Bilgisayar Mühendisliği - Oğuzhan Deniz", 1, "ğĞüÜşŞıİöÖçÇ");
        ...
        $processTwo		=	str_word_count("Karabük Üniversitesi - Bilgisayar Mühendisliği - Oğuzhan Deniz", 2, "ğĞüÜşŞıİöÖçÇ");
